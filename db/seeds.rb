...
User.create(email: "admin@abc.com", role_id: 0, company_id: Company.first.id)
User.create(email: "manager@def.com", role_id: 1, company_id: Company.second.id)
User.create(email: "user@def.com", role_id: 2, company_id: Company.second.id)
User.create(email: "manager@ghi.com", role_id: 0, company_id: Company.third.id)
User.create(email: "user@ghi.com", role_id: 1, company_id: Company.third.id)